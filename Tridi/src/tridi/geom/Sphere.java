...
public class Sphere implements Geometry {
	 ...
	 * slices=0 means adaptative rendering
	 */
	public Sphere(final SPoint center,final double radius,final int slices) {
		super();
		this.center=center;
		this.radius=radius;
		this.slices=slices;
	...
	public void render(final String id,final TriangleRenderer renderer) {
		...
		if(n == 0) {
			...
			renderer.renderTriangle.points[1].set(center.coords[0] + radius,center.coords[1] + radius,center.coords[2] + radius);
