...
public class HalfCylinder implements Geometry {
	...
	public void render(final String id, final TriangleRenderer renderer) {
		...
		for (int i = 0; i < n; ++i) {
			...
			renderer.renderTriangle.points[0].setFrom(baseCenter);
			renderer.renderTriangle.points[1].set(baseCenter.coords[0] + dx0, baseCenter.coords[1] + dy0,
					baseCenter.coords[2]);
			renderer.renderTriangle.points[2].set(baseCenter.coords[0] + dx1, baseCenter.coords[1] + dy1,
					baseCenter.coords[2]);
			renderer.renderTriangle.setSameNormals(0.0, 0.0, -1.0, true);
			renderer.renderTriangle.renderAsDelegate();
			renderer.renderTriangle.points[0].set(baseCenter.coords[0] + dx1, baseCenter.coords[1] + dy1,
					baseCenter.coords[2]);
			renderer.renderTriangle.normals[0].set(c1, s1, 0.0);
			renderer.renderTriangle.points[1].set(baseCenter.coords[0] + dx0, baseCenter.coords[1] + dy0,
					baseCenter.coords[2]);
			renderer.renderTriangle.normals[1].set(c0, s0, 0.0);
			renderer.renderTriangle.points[2].set(baseCenter.coords[0] + dx0, baseCenter.coords[1] + dy0,
					baseCenter.coords[2] + length);
			...
			renderer.renderTriangle.points[0].set(baseCenter.coords[0], baseCenter.coords[1],
					baseCenter.coords[2] + length);
			renderer.renderTriangle.points[1].set(baseCenter.coords[0] + dx1, baseCenter.coords[1] + dy1,
					baseCenter.coords[2] + length);
			renderer.renderTriangle.points[2].set(baseCenter.coords[0] + dx0, baseCenter.coords[1] + dy0,
					baseCenter.coords[2] + length);
			renderer.renderTriangle.setSameNormals(0.0, 0.0, 1.0, true);
		...
		renderer.renderTriangle.points[0].set(baseCenter.coords[0], baseCenter.coords[1] - radius,
				baseCenter.coords[2]);
		renderer.renderTriangle.points[1].set(baseCenter.coords[0], baseCenter.coords[1] + radius,
				baseCenter.coords[2]);
		renderer.renderTriangle.points[2].set(baseCenter.coords[0], baseCenter.coords[1] + radius,
				baseCenter.coords[2] + length);
	...
	public void renderObj(final String id, final ObjRenderer renderer) {
		...
		for (int i = 0; i < n; ++i) {
			...
			renderer.renderTriangle.setSameNormals(0.0, 0.0, -1.0, true);
			renderer.renderTriangle.renderAsDelegate();
			renderer.renderQuadrangle.points[0].set(baseCenter.coords[0] + dx1, baseCenter.coords[1] + dy1,
					baseCenter.coords[2]);
			renderer.renderQuadrangle.normals[0].set(c1, s1, 0.0);
			renderer.renderQuadrangle.points[1].set(baseCenter.coords[0] + dx0, baseCenter.coords[1] + dy0,
					baseCenter.coords[2]);
			renderer.renderQuadrangle.normals[1].set(c0, s0, 0.0);
			renderer.renderQuadrangle.points[2].set(baseCenter.coords[0] + dx0, baseCenter.coords[1] + dy0,
					baseCenter.coords[2] + length);
			renderer.renderQuadrangle.normals[2].set(c0, s0, 0.0);
			renderer.renderQuadrangle.points[3].set(baseCenter.coords[0] + dx1, baseCenter.coords[1] + dy1,
					baseCenter.coords[2] + length);
		...
		renderer.renderQuadrangle.points[0].set(baseCenter.coords[0], baseCenter.coords[1] - radius,
				baseCenter.coords[2]);
		renderer.renderQuadrangle.points[1].set(baseCenter.coords[0], baseCenter.coords[1] + radius,
				baseCenter.coords[2]);
		renderer.renderQuadrangle.points[1].set(baseCenter.coords[0], baseCenter.coords[1] + radius,
				baseCenter.coords[2] + length);
		renderer.renderQuadrangle.points[2].set(baseCenter.coords[0], baseCenter.coords[1] - radius,
				baseCenter.coords[2] + length);
